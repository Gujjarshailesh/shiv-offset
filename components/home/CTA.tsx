    ...
    <section className="relative py-24 overflow-hidden">
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="max-w-3xl mx-auto text-center">
          <span className="inline-block text-xs font-bold uppercase tracking-widest text-blue-200 mb-4 bg-white/10 px-4 py-1.5 rounded-full">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link
              href="/contact"
              className="group inline-flex items-center justify-center gap-2 bg-brand-500 text-slate-900 font-black px-8 py-4 rounded-xl hover:bg-brand-400 transition-all duration-200 shadow-[0_0_30px_rgba(245,158,11,0.4)] text-lg"
            >
              Request a Quote
          ...
          {/* Contact row */}
          <div className="mt-10 flex flex-wrap items-center justify-center gap-6 text-blue-200 text-sm">
